...
Brain = (function() {
  ...
  Brain.prototype.processCallTags = function(reply, scope) {
    var args, callRe, data, giveup, k, lang, match, matches, obj, output, parts, promisedReply, promises, text, usePromise;
    ...
    promisedReply = new RSVP.Promise(function(resolve, reject) {
      var j, len, p, ps;
      ps = [];
      ...
      return RSVP.all(ps).then((function(_this) {
        return function(results) {
          var i, l, ref, t, v;
          for (i = l = 0, ref = results.length; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
            t = promises[i].text;
            v = results[i];
  ...
  Brain.prototype._getReply = function(user, msg, context, step, scope) {
    ...
    reply = this.processCallTags(reply, scope);
    return reply;
  };
